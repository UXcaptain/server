...
import { posthogUserSubscriptionCancelled, posthogUserSubscriptionCreated, posthogUserSubscriptionEnded } from '../../models/posthogModel.mjs';
  ...
  try {
    ...
    switch (event.type) {
      ...
      case 'customer.subscription.updated':
        ...
        stripeCustomerId = event.data.object;

        switch (event.data.object.cancellation_details.feedback) {
          case 'renewed':

            break;

          case 'null': //* Using this to handle the double customer.subscription.update generated by leaving feedback on Stripe.
            posthogUserSubscriptionCancelled(stripeCustomerId);
